...
$$ J(b*0, b_1) = \frac{1}{2n} \sum*{i=1}^{n} \left( h\_{\mathbf{b}}(x_i) - y_i \right)^2 $$
...
$$ \frac{\partial J}{\partial b*0} = \frac{1}{n} \sum*{i=1}^{n} \left( h\_{\mathbf{b}}(x_i) - y_i \right) $$

$$ \frac{\partial J}{\partial b*1} = \frac{1}{n} \sum*{i=1}^{n} \left( h\_{\mathbf{b}}(x_i) - y_i \right) x_i $$
...
$$ h\_{\mathbf{b}}(x_i) = 0 \quad \text{for all } i $$

### 5.2 Compute Errors

$$ h*{\mathbf{b}}(x_1) - y_1 = 0 - 50 = -50 $$
$$ h*{\mathbf{b}}(x*2) - y_2 = 0 - 55 = -55 $$
$$ h*{\mathbf{b}}(x*3) - y_3 = 0 - 65 = -65 $$
$$ h*{\mathbf{b}}(x*4) - y_4 = 0 - 70 = -70 $$
$$ h*{\mathbf{b}}(x_5) - y_5 = 0 - 80 = -80 $$

Sum of errors:

$$ \sum*{i=1}^{n} \left( h*{\mathbf{b}}(x_i) - y_i \right) = -50 -55 -65 -70 -80 = -320 $$
...
_Cost function decreasing over gradient descent iterations._
...
_The regression line after 0, 1, 10, and 100 iterations (conceptual)._
...
\frac{1}{n} \sum_{i=1}^{n} \left( h_{\mathbf{b}}(x_i) - y_i \right)
```

```math
\frac{\partial J}{\partial b_1} =
\frac{1}{n} \sum_{i=1}^{n} \left( h_{\mathbf{b}}(x_i) - y_i \right) x_i
```
